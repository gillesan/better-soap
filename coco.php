            ...
            <div class="about-box">
                <div class="service-content">
                    <div class="service-section clearfix">
                        <h1>Coco - SAVON</h1>
                        <img src="upload/produitSavon267x205 (4).jpg" alt=""/>
                        <p>Ce savon à la douce odeur de noix de coco conviendra à tous les types de peaux.</p>	
                    ...
                    <div class="tabs service-section last-section">		
                        ...
                        <div class="tabs-widget clearfix">
                            ...
                            <div id="graphic" style="display: block;">
                                <ul>
                                    <li>
                                        <p>huile de tournesol, huile de coco, beurre de cacao</p>
                                    </li>
                                </ul>
                            </div>
