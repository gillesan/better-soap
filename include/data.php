...
/*
$huileVeg = array(
    "all" => array($amadeDouce, $avocat, $sonBle, $beurreCacao, $coco, $coprah, $jojoba, $karite, $murumur, $olive, $palme, $ricin, $tournesol ),
    "miel-avoine" => array($olive, $coco, $palme, $karite, $ricin),
...
$huileEss = array(
    "all" => array($bayStThomas, $camomilleRomaine, $cannelleCeylan, $cedreAtlas, $epiceaCommun , $geraniumRosat, $lavandeVraie, $mandarineRouge, $menthePoivree, $orangeDouce, $pamplemousse, $patchouli, $grainBigarade, $pinSylvestre, $romarinCineole, $teaTree),
    "miel-avoine" => array(),
...
$ajout = array(
    "all" => array($argile, $avoine, $charbon, $cire, $naticide, $aromatiquesNaturels, $fragrances, $miel, $ocres, $poudreRose, $poudreOrange, $rhassoul, $sci, $matcha, $cidre, $vitamineE, $lait, $boutonRose, $romarinPoudre),
    "miel-avoine" => array($lait, $avoine, $miel),
    ...
    "herbe" => array($sci, $romarinPoudre, $rhassoul),
    "baume" => array($cire, $miel, $vitamineE, $poudreRose),
    "automne" => array($cidre, $ocres));
*/

$huileVegALL = array($amadeDouce, $avocat, $sonBle, $beurreCacao, $coco, $coprah, $jojoba, $karite, $murumur, $olive, $palme, $ricin, $tournesol );

$huileEssALL = array($bayStThomas, $camomilleRomaine, $cannelleCeylan, $cedreAtlas, $epiceaCommun , $geraniumRosat, $lavandeVraie, $mandarineRouge, $menthePoivree, $orangeDouce, $pamplemousse, $patchouli, $grainBigarade, $pinSylvestre, $romarinCineole, $teaTree);

$ajoutALL = array($argile, $avoine, $charbon, $cire, $naticide, $aromatiquesNaturels, $fragrances, $miel, $ocres, $poudreRose, $poudreOrange, $rhassoul, $sci, $matcha, $cidre, $vitamineE, $lait, $boutonRose, $romarinPoudre);
