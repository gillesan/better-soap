...
switch ($origin) {
    ...
    case "miel-avoine":
        ...
        $explIngr = '';
        $sliderIngredient = '<li>
                                    <img src="xxx" alt="Miel-Avoine - SAVON"/>
                                </li>';
        break;
    case "charbon-actif":
        ...
        $explIngr = '';
        $sliderIngredient = '<li>
                                    <img src="xxx" alt="Charbon Actif - SAVON"/>
                                </li>';
        break;
    case "sapin":
        $titleh1 = "Sapin - SAVON";
    ...
    case "orange-shamp":
        ...
        $explIngr = '';
        $sliderIngredient = '<li>
                                    <img src="xxx" alt="Orange - SHAMPOO"/>
                                </li>';
        break;
    case "lavande":
        ...
        $explIngr = '';
        $sliderIngredient = '<li>
                                    <img src="xxx" alt="Lavande - SHAMPOO"/>
                                </li>';
        break;
    case "herbe":
        ...
        $explIngr = '';
        $sliderIngredient = '<li>
                                    <img src="xxx" alt="Herbes de Provence - SHAMPOO"/>
                                </li>';
        break;
    case "baume":
