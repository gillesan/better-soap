                            ...
                            <div class="row">
                                <div class="col-md-2">
                                    <div class="view view-first"> 
                                        <img src="upload/project1.jpg" alt="" /> 
                                        <div class="mask"> 
                                            <div class="i-icons">
                                ...
                                <div class="col-md-2">
                                    <div class="view view-first"> 
                                        <img src="upload/project2.jpg" alt="" /> 
                                        <div class="mask"> 
                                            <div class="i-icons">
                                                <a href="#"><i class="fa fa-plus"></i></a>
                                            </div>
                                ...
                                <div class="col-md-2">
                                    <div class="view view-first"> 
                                        <img src="upload/project3.jpg" alt="" /> 
                                        <div class="mask"> 
                                            <div class="i-icons">
                                                <a href="#"><i class="fa fa-plus"></i></a>
                                            </div>
                                ...
                                <div class="col-md-2">
                                    <div class="view view-first"> 
                                        <img src="upload/project4.jpg" alt="" /> 
                                        <div class="mask"> 
                                            <div class="i-icons">
                                                <a href="#"><i class="fa fa-plus"></i></a>
                                            </div>
                                ...
                                <div class="col-md-2">
                                    <div class="view view-first"> 
                                        <img src="upload/project5.jpg" alt="" /> 
                                        <div class="mask"> 
                                            <div class="i-icons">
                                                <a href="#"><i class="fa fa-plus"></i></a>
                                            </div>
                                ...
                                <div class="col-md-2">
                                    <div class="view view-first"> 
                                        <img src="upload/project6.jpg" alt="" /> 
                                        <div class="mask"> 
                                            <div class="i-icons">
                                                <a href="#"><i class="fa fa-plus"></i></a>
                                            </div>
